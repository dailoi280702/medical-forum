...
const Header = () => {
  ...
  return (
    <nav className='sticky overflow-hidden top-0 w-full z-20 bg-white/80 text-neutral-900  p-4 shadow-sm transition-all dark:shadow-md dark:text-neutral-100 dark:bg-neutral-800/80 backdrop-blur-sm'>
      <div className='flex flex-col items-start h-full max-w-4xl mx-auto text-md md:flex md:items-center md:flex-row md:space-x-3'>
        ...
        <AnimatePresence>
          <motion.div
            ...
            className={`space-y-6 my-8 px-4 md:flex items-center md:my-0 md:space-y-0 md:space-x-5 truncate w-full md:w-fit ${
              !open ? 'hidden' : ''
            }`}
          >
            {routes
